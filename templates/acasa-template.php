...
<section class="block container">
  <div class="hero">
    <div class="hero-content content row">
      ...
      <div class="small-12 columns actions">
        <a href="<?php the_field('what_we_work_link_url'); ?>" class="button large underline">
      ...
      <?php
        ...
        if($query->have_posts()) { ?>
          <div class="small-offset-1 small-10 medium-offset-0 medium-12 columns project-list" data-equalizer data-equalize-on="small" data-equalize-on-stack="false" data-equalize-by-row="true">
            <?php
        ...
        <div class="row activities">
          <?php
            ...
            foreach ($entities as $entity) {
              ...
              $html = "<div class='small-12 medium-6 large-3 columns'>" .
