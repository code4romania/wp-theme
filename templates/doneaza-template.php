      ...
      <div class="donate row">
        <div class="small-12 large-6 columns">
          <div class="donate-option">
            ...
            <p class="donate-info"><small>PayPal este un procesator de plăţi online cu peste 14 ani experienţă în siguranţa datelor si <a href="http://66.media.tumblr.com/3e2170e16a9d5cf0bdb4af264fae1534/tumblr_nugr8k4aqS1r3kmkso4_r1_500.gif" target="_blank" class="easter">tehnologii</a> de ultimă generaţie.</small></p>
          </div>
        </div>
        <div class="small-12 large-6 columns">
          <h2>În conturi</h2>
